...
show7.onclick = function(event) {
	window7.style.display = 'flex';
}
close7.onclick = function(event) {
	window7.style.display = 'none';
}

show8.onclick = function(event) {
	window8.style.display = 'flex';
}
close8.onclick = function(event) {
	window8.style.display = 'none';
}

show9.onclick = function(event) {
	window9.style.display = 'flex';
}
close9.onclick = function(event) {
	window9.style.display = 'none';
}

show10.onclick = function(event) {
	window10.style.display = 'flex';
}
close10.onclick = function(event) {
	window10.style.display = 'none';
}

show11.onclick = function(event) {
	window11.style.display = 'flex';
}
close11.onclick = function(event) {
	window11.style.display = 'none';
}

show12.onclick = function(event) {
	window12.style.display = 'flex';
}
close12.onclick = function(event) {
	window12.style.display = 'none';
}

show13.onclick = function(event) {
	window13.style.display = 'flex';
}
close13.onclick = function(event) {
	window13.style.display = 'none';
}

show14.onclick = function(event) {
	window14.style.display = 'flex';
}
close14.onclick = function(event) {
...
if (window.innerWidth > 900){
	...
	window7.style.left = 10 + 'px';
	window7.style.width = window.innerWidth - 20 + 'px';
	window7.style.height = window.innerHeight - 20 + 'px';

	window8.style.left = 10 + 'px';
	window8.style.width = window.innerWidth - 20 + 'px';
	window8.style.height = window.innerHeight - 20 + 'px';

	window9.style.left = 10 + 'px';
	window9.style.width = window.innerWidth - 20 + 'px';
	window9.style.height = window.innerHeight - 20 + 'px';

	window10.style.left = 10 + 'px';
	window10.style.width = window.innerWidth - 20 + 'px';
	window10.style.height = window.innerHeight - 20 + 'px';

	window11.style.left = 10 + 'px';
	window11.style.width = window.innerWidth - 20 + 'px';
	window11.style.height = window.innerHeight - 20 + 'px';

	window12.style.left = 10 + 'px';
	window12.style.width = window.innerWidth - 20 + 'px';
	window12.style.height = window.innerHeight - 20 + 'px';

	window13.style.left = 10 + 'px';
	window13.style.width = window.innerWidth - 20 + 'px';
	window13.style.height = window.innerHeight - 20 + 'px';

	window14.style.left = 10 + 'px';
	window14.style.width = window.innerWidth - 20 + 'px';
	window14.style.height = window.innerHeight - 20 + 'px';
	...
	document.onscroll = function(event) {
		...
		window7.style.top = scrollY + 10 + 'px';
		window8.style.top = scrollY + 10 + 'px';
		window9.style.top = scrollY + 10 + 'px';
		window10.style.top = scrollY + 10 + 'px';
		window11.style.top = scrollY + 10 + 'px';
		window12.style.top = scrollY + 10 + 'px';
		window13.style.top = scrollY + 10 + 'px';
		window14.style.top = scrollY + 10 + 'px';
	}
}